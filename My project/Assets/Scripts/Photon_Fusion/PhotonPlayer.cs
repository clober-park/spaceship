...
public class PhotonPlayer : NetworkBehaviour
{
    ...
    public static void OnBallSpawned(Changed<PhotonPlayer> changed)
    {
        changed.Behaviour.material.color = Color.white; 
        var newValue = changed.Behaviour.material.color;
        changed.LoadOld();
        var oldValue = changed.Behaviour.material.color;
    }
